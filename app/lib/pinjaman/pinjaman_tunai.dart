                    ...
                    child: Column(
                      children: [
                        ...
                        Container(
                            ...
                            child: Align(
                                alignment: Alignment.topLeft,
                                child: Text("Rp. " + (dataTagihan != null ? dataTagihan['tagihan'].toString() : '0'),
                            ...
                            child: Align(
                                ...
                                child: Text(
                                    (dataTagihan != null
                                        ...
                                        : '-'),
                                    style: TextStyle(
                                        fontWeight: FontWeight.w700, fontSize: 12, color: getColorFromHex('32c8b1'))))),
                      ],
                    )),
                Expanded(
                    flex: 3,
        ...
        Container(
            ...
            child: Row(
              children: [
                ...
                const Expanded(
                    flex: 8, child: Text("Tagihan saya", style: TextStyle(fontSize: 14, fontWeight: FontWeight.w700))),
                Expanded(
                    flex: 1,
                    child: InkWell(
                      onTap: () {
              ...
              children: [
                Container(
                  ...
                  child: Row(children: [
                    ...
                    const Expanded(
                        flex: 9,
                        child: Text("Riwayat Transaksi", style: TextStyle(fontSize: 14, fontWeight: FontWeight.w700)))
                  ]),
                ),
                Container(
